...
namespace GUI {
	namespace Elements {
		...
		Window::Window(elemId_t id) : ElementContainer(id) {
			this->parentWindow = id;
			this->__current_type = &typeid(Window);
			this->Element::__current_type = &typeid(Window);
			this->Container::__current_type = &typeid(Window);
			this->ElementContainer::__current_type = &typeid(Window);
